...
Minden főkategóriának vannak alkategóriái, melyek listája nincsen rögzítve, hanem bármikor bővíthető az új technológiák vagy szakmák megjelenésével. Az alkategóriák közé tartozhat például az ács, amely a Kivitelező főkategóriába sorolandó, vagy éppen a belsőépítészeti tervező, amely pedig a Tervező főkategória alkategóriája kell legyen. Ezen listák bővítését csak az adminisztrátor jogú felhasználók végezhetik el az erre biztosított oldalon (\kovAzon{Ka\_\sorSzamK}). Minden alkategória hozzáadásánál meg kell adniuk az adminisztrátoroknak, hogy mely főkategóriába tartozik az adott elem.
...
A "Segítség, építkezem!" weboldal két kereső oldallal rendelkezik, melyek közül az egyik feladata, hogy a felhasználó megtalálja a számára legalkalmasabb szakembert/szakembereket (\kovAzon{Sz\_\sorSzamSz}). Erre több előre definiált szűrő és egy általános kereső lesz a felhasználó segítségére (\kovAzon{Sz\_\sorSzamSz}). Az előre definiált szűrőkkel a szakemberek 
\begin{itemize}
     \item nevére,
     \item fő- és alkategóriáira,
     \item földrajzi helyére (megyei szinten),
     \item értékelésére,
     \item általa használt termékekre,
     \item általa nyújtott szolgáltatásokra,
\end{itemize}
tud szűkíteni a felhasználó, míg az általános keresővel a szakember összes publikus adata között tud keresni.
\clearpage
...
A keresési eredmények rendezhetőek is a szakember értékelése és a referenciák száma alapján (\kovAzon{Sz\_\sorSzamSz}).
