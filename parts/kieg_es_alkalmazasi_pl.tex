...
A \textit{Segtíség, építkezem!} weboldal első körben magyar nyelven kell készüljön (\kovAzon{E\_\sorSzamE}). Az oldal minden képernyőméretben jól használható (\kovAzon{E\_\sorSzamE}) és akadálymentesített kell legyen, illetve rendelkeznie kell nagy kontrasztú változattal (\kovAzon{E\_\sorSzamE}).
